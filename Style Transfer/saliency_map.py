...
##############################################################################
#Define saliency interprater
saliency = Saliency(model)
#compute saliency map
attribution = saliency.attribute(X_tensor,target=y_tensor)

#visualization
visualize_attr_maps('visualization/saliency_captum.png', X, y, class_names, [attribution], ['Saliency Map'])
